...
real*8 function fSScr_skinD(a, b, t, r, Ec_skin, nu_skin)
    ...
    real*8 a, b, t, r, Ec_skin, nu_skin, ks, Z, ratio
    real*8 ks_90_1, ks_30_1, ks_20_1, ks_15_1, ks_10_1
    real*8 ks_90_2, ks_30_2, ks_20_2, ks_15_2, ks_10_2
    real*8 ks_20, ks_15
    real*8 pi
    pi = atan(1.)*4
...
real*8 function fSCcr_skinD(a, b, t, r, Ec_skin, nu_skin)
    ...
    real*8 Z
    real*8 a, b, t, r, Ec_skin, nu_skin, ratio, kc
    real*8 kc_3000_1, kc_2000_1, kc_1000_1, kc_700_1, kc_500_1
    real*8 kc_3000_2, kc_2000_2, kc_1000_2, kc_700_2, kc_500_2
    real*8 pi
    pi = atan(1.)*4
...
real*8 function fSratio_strD(kk, a, b)
    ...
    real*8 kk, a, b, ratio
    real*8 fst_ratio_0, fst_ratio_2, fst_ratio_4, fst_ratio_6, fst_ratio_8
...
real*8 function fSratio_frD(kk, ask, bsk)
    ...
    real*8 kk, ask, bsk
    real*8 ratio
    real*8 ffr_ratio_0, ffr_ratio_2, ffr_ratio_4, ffr_ratio_6, ffr_ratio_8
...
real*8 function SFC_allow_strD(kleft, kright, tleft, tright, tweb, fcy, Ec)
    ...
    real*8 kleft, kright, tleft, tright, tweb, fcy, Ec
    real*8 ratio, n, c
...
real*8 function Ffr_allowD(kk, tweb, tskin, Rin, fcy, Ec)
    ...
    real*8 kk, tweb, tskin, Rin, fcy, Ec
    real*8 ratio, N_20, N_40, N_60, N_75, N_100, N_125, n, c
...
real*8 Function fs_allow_FtuD(ask, bsk, tskin, Afr, Astr, kk, alpha, Ftu_fs)
    ...
    real*8 ask, bsk, tskin, Afr, Astr, kk, alpha, Ftu_fs
    real*8 fs_allow_Ftu_30, fs_allow_Ftu_40, fs_allow_Ftu_50, fs_allow_Ftu_62, fs_allow_Ftu_70
    real*8 fs_allow_Ftu_80, fs_allow_Ftu_90, fs_allow_Ftu_100, fs_allow_Ftu_110, fs_allow_Ftu_120
    real*8 x1, x2, y1, y2, delta
